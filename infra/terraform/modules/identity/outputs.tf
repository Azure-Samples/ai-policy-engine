...
output "api_app_object_id" {
  description = "Object ID of the AI Policy API app registration."
  value       = azuread_application.api.object_id
}

output "api_application_id" {
  description = "Terraform resource ID of the AI Policy API app registration."
  value       = azuread_application.api.id
}

output "api_sp_id" {
  description = "Object ID of the AI Policy API service principal."
...
output "client1_application_id" {
  description = "Terraform resource ID of the AI Policy Sample Client app registration."
...
output "role_apim_id" {
  description = "UUID of the AI Policy APIM app role."
  value       = random_uuid.role_apim.result
}

output "gateway_app_id" {
  description = "Application (client) ID of the AI Policy APIM Gateway app registration."
  value       = azuread_application.gateway.client_id
}

output "gateway_application_id" {
  description = "Terraform resource ID of the AI Policy APIM Gateway app registration."
  value       = azuread_application.gateway.id
}

output "gateway_scope_id" {
  description = "ID of the access_as_user OAuth2 permission scope on the AI Policy APIM Gateway app."
